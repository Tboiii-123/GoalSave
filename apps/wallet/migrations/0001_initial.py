    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_transferred', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['reference'], name='wallet_wall_referen_b8b9fb_idx'), models.Index(fields=['transaction_type'], name='wallet_wall_transac_2c0a43_idx'), models.Index(fields=['status'], name='wallet_wall_status_66d39d_idx'), models.Index(fields=['created_at'], name='wallet_wall_created_929d33_idx'), models.Index(fields=['wallet', 'status'], name='wallet_wall_wallet__235478_idx')],
            },
        ),
    ]
